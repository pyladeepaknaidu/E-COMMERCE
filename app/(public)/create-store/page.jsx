                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on <span className="text-slate-900 font-semibold">FLASH</span> <span className="text-red-600">⚡</span> <span className="text-slate-900 font-semibold">MAN</span>, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
